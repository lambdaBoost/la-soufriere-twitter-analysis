...
Script to load and process retweet csv files in preparation for insertion into neo4j and subsequent analysis

Originally written as part of a BGS/UWI mob
"""
